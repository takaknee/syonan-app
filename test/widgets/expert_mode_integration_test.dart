...
void main() {
  group('Expert Mode Integration Tests', () {
    testWidgets('PracticeScreen should show expert mode indicator when difficulty level is 5',
        (tester) async {
    ...
    testWidgets('PracticeScreen should not show expert mode indicator for normal difficulty',
        (tester) async {
      await tester.pumpWidget(
        MultiProvider(
          providers: [
    ...
    testWidgets('PracticeScreen should show level indicator for medium difficulty',
        (tester) async {
      await tester.pumpWidget(
        MultiProvider(
          providers: [
